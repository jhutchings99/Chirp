...
var app = new Vue({
    ...
    methods: {
        ...
        createComment: async function (message, user_id, chirp_id) {
            let response = await fetch(`${URL}/users/${user_id}/chirps/${chirp_id}/comments`, {
                method: 'POST',
                body: message
            });
            let data = await response.json();
        ...
        postingComment: async function (comment) {
